...
int main() {
    ...
    cout << "Bonjour bienvenue dans ce programme qui vous donnera tous les nombre premiers dans la limite de l'intervalle que vous aurez choisi." << endl;
    ...
    do {
        ...
        do { //boucle pour répéter le programme tant que l'utilisateur ne donne pas N
        ...
        } while (reponse != 'O' && reponse != 'o' && reponse != 'N' && reponse != 'n'); // Continue de demander tant que l'entrée est incorrecte
